(function () {
    ...
    while(true) {
      ...
      if (exit$1 === 2) {
        if (self_hi !== -2147483648) {
          ...
          if (exit$2 === 3) {
            var rem = sub$2(self, mul(other, approx));
  ...
  function ksprintf(k, param) {
    ...
    return make_printf(k$p, undefined, /* End_of_acc */0, param._0);
  }
