(function () {
  ...
  function scoreString(score) {
    ...
    var slen = s.length;
    if (slen <= blen) {
      return sub$2(b, blen - slen | 0, slen);
    } else {
      return s;
    }
  }
  ...
  function make$1(hasGravityOpt, speedOpt, dirOpt, objTyp, spriteParams, px, py) {
  ...
  function evolveEnemy(player_dir, typ, spr, obj) {
    switch (typ) {
      case /* Goomba */0 :
          ...
          return ;
      case /* GKoopa */1 :
          var newObj = make$1(undefined, 3, obj.dir, {
                TAG: /* Enemy */1,
                _0: /* GKoopaShell */3
          ...
          return newObj;
      case /* RKoopa */2 :
          return make$1(undefined, 3, obj.dir, {
                      TAG: /* Enemy */1,
                      _0: /* RKoopaShell */4
  ...
  function evolveBlock(obj) {
    decHealth(obj);
    return make$1(false, undefined, obj.dir, {
                TAG: /* Block */3,
                _0: /* QBlockUsed */0
  ...
  function spawnAbove(player_dir, obj, itemTyp) {
    var item = make$1(itemTyp !== /* Coin */1, undefined, /* Left */0, {
          TAG: /* Item */2,
          _0: itemTyp
    ...
    switch (t.TAG | 0) {
      ...
      case /* Enemy */1 :
          ...
          var remains = t._0 !== 0 ? /* [] */0 : ({
                hd: make(undefined, undefined, /* GoombaSquish */0, obj.px, obj.py),
                tl: /* [] */0
              });
  ...
  function convertCoinToObj(param) {
    return make$1(false, undefined, undefined, {
                TAG: /* Item */2,
                _0: /* Coin */1
  ...
  function convertEnemyToObj(param) {
    ...
    var obj = make$1(undefined, undefined, undefined, {
          TAG: /* Enemy */1,
          _0: enemyTyp
  ...
  function generatePanel(level) {
    return make$1(undefined, undefined, undefined, {
                TAG: /* Block */3,
                _0: /* Panel */4
  ...
  function generate(level) {
    ...
    var player1 = make$1(undefined, undefined, undefined, {
          TAG: /* Player */0,
          _0: /* SmallM */1,
          _1: /* One */0
        }, makePlayer(/* SmallM */1, /* Standing */0, /* Left */0, /* One */0), 100, 224);
    var player2 = make$1(undefined, undefined, undefined, {
          TAG: /* Player */0,
          _0: /* SmallM */1,
          _1: /* Two */1
  ...
  function updateLoop(player1, player2, level, objects) {
    var viewport = make$2(getCanvasSizeScaled(), mapDim(level));
