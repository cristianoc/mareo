...
function evolve_enemy(player_dir, typ, spr, obj, context) {
  switch (typ) {
    case /* Goomba */0 :
        ...
        return ;
    case /* GKoopa */1 :
        var match = make(obj.dir, /* SEnemy */Block.__(1, [/* GKoopaShell */3]), context, obj.pos);
        var new_obj = match[1];
        var new_spr = match[0];
    ...
    case /* RKoopa */2 :
        var match$1 = make(obj.dir, /* SEnemy */Block.__(1, [/* RKoopaShell */4]), context, obj.pos);
...
function evolve_block(obj, context) {
  dec_health(obj);
  var match = make(undefined, /* SBlock */Block.__(3, [/* QBlockUsed */0]), context, obj.pos);
  return /* Block */Block.__(3, [
            /* QBlockUsed */0,
            match[0],
            match[1]
...
function spawn_above(player_dir, obj, typ, context) {
  var item = spawn(/* SItem */Block.__(2, [typ]), context, obj.pos);
  var item_obj = item[2];
