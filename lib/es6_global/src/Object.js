...
function make($staropt$star, spawnable, context, param) {
...
function spawn(spawnable, context, param) {
  var match = make(undefined, spawnable, context, /* tuple */[
        param[0],
        param[1]
      ]);
  var obj = match[1];
...
function evolve_enemy(player_dir, typ, spr, obj, context) {
  switch (typ) {
    case /* Goomba */0 :
        ...
        return ;
    case /* GKoopa */1 :
        var match = make(obj.dir, /* SEnemy */Block.__(1, [/* GKoopaShell */3]), context, /* tuple */[
              obj.pos.x,
              obj.pos.y
            ]);
        var new_obj = match[1];
    ...
    case /* RKoopa */2 :
        var match$1 = make(obj.dir, /* SEnemy */Block.__(1, [/* RKoopaShell */4]), context, /* tuple */[
              obj.pos.x,
              obj.pos.y
            ]);
...
function evolve_block(obj, context) {
  dec_health(obj);
  var match = make(undefined, /* SBlock */Block.__(3, [/* QBlockUsed */0]), context, /* tuple */[
        obj.pos.x,
        obj.pos.y
      ]);
  return /* Block */Block.__(3, [
