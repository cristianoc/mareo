          ...
          case /* Block */3 :
              ...
              if (dir >= 2) {
                if (t1 >= 3) {
                  ...
                  var spawned_item$1 = $$Object.spawn_above(o1$3.dir, o2$4, t2$1[0], context);
                  $$Object.rev_dir(o1$3, t1, s1);
                  return /* tuple */[
                          updated_block$1,
                          spawned_item$1
...
function narrow_phase(c, cs, state) {
  ...
  while(true) {
    ...
    if ($$Object.equals(c, h)) {
      ...
      new_objs = dir !== undefined && $$Object.get_obj(h).id !== c_obj.id ? process_collision(dir, c, h, state) : /* tuple */[
          undefined,
          undefined
        ];
    }
