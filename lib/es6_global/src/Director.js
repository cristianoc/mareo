  ...
  switch (c1.tag | 0) {
        ...
        switch (c2.tag | 0) {
          ...
          case /* Block */3 :
              ...
              if (dir !== 0) {
                ...
                var spawned_item = $$Object.spawn_above(o1$2.dir, o2$3, t[0], context);
                $$Object.collide_block(dir, o1$2);
                return /* tuple */[
                        spawned_item,
                        updated_block
          ...
          case /* Block */3 :
              ...
              if (dir >= 2) {
                if (t1 >= 3) {
                  ...
                  var updated_block$1 = $$Object.evolve_block(o2$5, context);
                  var spawned_item$1 = $$Object.spawn_above(o1$3.dir, o2$5, t2$2[0], context);
                  $$Object.rev_dir(o1$3, t1, s1);
                  return /* tuple */[
                          updated_block$1,
                          spawned_item$1
    ...
    case /* Item */2 :
        ...
        switch (c2.tag | 0) {
          ...
          case /* Block */3 :
              if (dir >= 2) {
                $$Object.reverse_left_right(o2$6);
                return /* tuple */[
                        undefined,
                        undefined
                      ];
              } else {
                $$Object.collide_block(dir, o2$6);
                return /* tuple */[
                        undefined,
                        undefined
                      ];
  ...
  var update_helper = function (time, state, _player, _objs, _parts) {
    while(true) {
      ...
      if (typeof t === "number") {
        ...
        Belt_List.forEach(objs, (function(objs,state$1){
            return function (obj) {
              return run_update_collid(state$1, obj, objs);
            }
            }(objs,state$1)));
        Belt_List.forEach(parts, (function(state$1){
            return function (part) {
              Particle.$$process(part);
              var x = part.pos.x - Viewport.getPos(state$1.vpt).x;
              var y = part.pos.y - Viewport.getPos(state$1.vpt).y;
      ...
      var match = Procedural_generator.generate(Config.level_width, Config.level_height, state.ctx);
